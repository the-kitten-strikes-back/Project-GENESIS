...
class SimulationConfig:
    ...
    hunt_efficiency: float = 1.65
    temperature_stress_scale: float = 0.70
    terrain_drag_scale: float = 0.28
    ...
    predator_recovery_floor: int = 8
    predator_recovery_interval: int = 30
